...
var OktaAuthService = /** @class */ (function () {
    function OktaAuthService(auth, router) {
        ...
        configuration_validation_1.assertIssuer(auth.issuer, auth.testing);
         ...
         */
        this.config = configuration_validation_1.buildConfigObject(auth); // use normalized config object
    ...
    OktaAuthService.prototype.loginRedirect = function (fromUri, additionalParams) {
        ...
        var params = configuration_validation_1.buildConfigObject(additionalParams);
